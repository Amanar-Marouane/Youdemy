    ...
    <main class="flex-1 p-6">
        ...
        <section class="max-w-9xl mx-auto space-y-6 mt-5">
            ...
            <div class="bg-gray-800 p-4 rounded-lg shadow-md">
                <h3 class="text-xl font-semibold text-indigo-500">Total Tags</h3>
                <p class="text-3xl font-bold text-red-300"><?= $total_tags ?></p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex gap-4">
                            <textarea
                                ...
                                placeholder="Enter your tag(s)"></textarea>
                            <button
                                type="submit"
            ...
            <div class="bg-gray-800 rounded-lg overflow-hidden">
                <div class="p-4 border-b border-gray-700">
                    <h2 class="text-lg font-semibold text-white">Existing Tags</h2>
                </div>
                <div class="p-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php foreach ($tags as $tag):
                            extract($tag) ?>
                            <div class="bg-gray-700 rounded-lg p-4 flex justify-between items-center tag">
                                <div class="flex items-center gap-3">
                                    <svg class="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                    </svg>
                                    <span class="text-white"><?= $tag_content ?></span>
                                </div>
                                <form action="/dashboard/tags/delete" class="deleteForm">
...
<script>
    ...
    $(document).ready(function() {
        $(".deleteForm").on('submit', function(e) {
            ...
            const user_id = $(document.activeElement).closest('form').find('#tag_id').val();
            const target_element = $(document.activeElement).closest('.tag');
