<aside class="w-64 bg-gray-800 rounded-lg shadow-lg">
    <nav class="p-4">
        <ul class="space-y-2">
            <li>
                <a href="/dashboard/accounts" class="<?php if ("dashboard/accounts" === getURI()): ?> bg-indigo-600 hover:bg-indigo-500 <?php else: ?> hover:bg-gray-700 <?php endif; ?> flex items-center gap-3 px-4 py-3 text-gray-300 rounded-lg transition-colors duration-200">
            ...
            <li>
                <a href="/dashboard/categories" class="<?php if ("dashboard/categories" === getURI()): ?> bg-indigo-600 hover:bg-indigo-500 <?php else: ?> hover:bg-gray-700 <?php endif; ?>flex items-center gap-3 px-4 py-3 text-gray-300 rounded-lg transition-colors duration-200">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="/dashboard/tags" class="<?php if ("dashboard/tags" === getURI()): ?> bg-indigo-600 hover:bg-indigo-500 <?php else: ?> hover:bg-gray-700 <?php endif; ?> flex items-center gap-3 px-4 py-3 text-gray-300 rounded-lg transition-colors duration-200">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
